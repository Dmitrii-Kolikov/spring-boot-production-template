...
class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    fun businessException(ex: BusinessException): BaseResponse<Nothing> {
        return BaseResponse(false, null, ErrorDto(
            code = ex.code,
            title = ex.title,
            subCode = ex.subCode,
    ...
    @ExceptionHandler(UserHeaderException::class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    fun userHeaderException(ex: UserHeaderException): BaseResponse<Nothing> {
        return BaseResponse(false, null, ErrorDto(
            code = ex.code,
