...
class RestLoggingFilter(
    ...
    override fun doFilterInternal(request: HttpServletRequest, response: HttpServletResponse, filterChain: FilterChain) {
        ...
        val isRequestFile = isFileContentType(requestContentType)
        ...
        try {
            ...
            if (!isAsyncDispatch(request) && request.isAsyncStarted) {
                ...
                val isResponseFile = isFileContentType(responseContentType)
    ...
    private fun isFileContentType(contentType: String?): Boolean {
