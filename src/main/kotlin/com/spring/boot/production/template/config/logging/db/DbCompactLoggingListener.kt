package com.spring.boot.production.template.config.logging.db
...
import com.spring.boot.production.template.config.exception.DatabaseOperationException
...
class DbCompactLoggingListener(
    ...
    private fun getRowsCount(result: Any?, methodName: String): String {
        ...
        return when (result) {
            ...
            is Slice<*> -> "${result.content.size} (страница)"
